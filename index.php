        ...
        <div class="col-md-6">
          <div class="card custom-card crd-img ">
            ...
            <div class="card-img-overlay">
              ...
              <a href="sport-register.php?id=<?php echo $sportId; ?>" class="btn btn-success btn-sm ">Details /
                Register</a>
            </div>
          </div>
        </div> <!-- end of col -->
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="coach">
            ...
            <a href=" teacher-enroll.php?id=<?php echo $teacherId ?>" class="btn enrollB font-weight-bold mt-1 "> ENROLL
            </a>
          </div> <!-- end of coah -->
        </div> <!-- end of col -->
        <?php
