...
<head>
  ...
  <link rel="stylesheet"
    href="assets/css/custom.css?v=<?php echo time(); ?>">
...
<body data-spy="scroll" data-target='#collapsibleNavbar'>
  ...
  <section id="HEADER">
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
      <!-- Brand -->
      <div class="container">
        <a class="navbar-brand" style="font-family:cursive;" href="#">Gc SP<img src="assets/img/logo/main-logo-2.png"
            alt="Logo" style="width:40px; "> RTS </a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item mr-3">
              <a class="nav-link btn btn-success " style="border-radius:0px;" href="signup2.php"
      ...
      <div class="row">
        <div class="col-sm-4 m-auto">
          <div class="card pb-3 up">
            <img class="card-img-top img-fluid" src="assets/img/upcoming/thumb.jpg" alt="Card image cap">
            <div class="card-block">
              <h5 class="card-title px-3 pt-2">Card title</h5>
              <p class="card-text px-3">Some quick example text to build on the card title.</p>
              <span class="pl-3"> <small>October 23 </small> </span>
              <span class="float-right pr-3 text-muted"> <small>10 days left </small> </span>
            </div>
          </div> <!-- end of card -->
        </div> <!-- end of col -->
        <div class="col-sm-4">
        ...
        <div class="col-md-6">
          <div class="card custom-card crd-img ">
            <img class="card-img-top img-fluid"
              src="admin/upload/sports/<?php echo $sportImage; ?>">
            <div class="card-img-overlay">
              <h4 class="card-title"><?php echo $sportName; ?>
              </h4>
              <a href="sport-register.php?id=<?php echo $sportId; ?>"
                class="btn btn-success btn-sm ">Details / Register</a>
            </div>
          </div>
        </div> <!-- end of col -->
        <?php
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="coach">
            <img
              src="admin/upload/teachers/<?php echo $teacherImage ?>"
              alt="Teacher" style="width:100%">
            <h4 class="mx-2 mt-1"><?php echo $teacherName ?>
            </h4>
            <p class="title"><?php echo $teacherDetails ?>
            </p>
            <p><?php echo $teacherShort ?>
            </p>
            <a href="#"><i class="fas fa-envelope"></i></a>
            <a href="#"><i class="fab fa-twitter"></i></a>
            <a href="#"><i class="fab fa-linkedin"></i></a>
            <a href="#"><i class="fab fa-facebook"></i></a>
            <a href=" teacher-enroll.php?id=<?php echo $teacherId ?>"
              class="btn enrollB font-weight-bold mt-1 "> ENROLL </a>
          </div> <!-- end of coah -->
        </div> <!-- end of col -->
        <?php
        } ?>
