		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav ml-auto text-center">
					...
					<li class="nav-item mr-3">
						<?php if (!login()): ?>
						<a class="nav-link  " style="border-radius:0px;" href="">Teacher</a>
						<?php endif; ?>
					</li>
					<li class="nav-item mr-3">
						<a class="nav-link active " style="border-radius:0px;" href="signup2.php">Student</a>
					</li>
					<li class="nav-item mr-3">
						<?php if (login()): ?>
					...
					<li class="nav-item mr-3">
						<?php if (login()): ?>
						<a class="nav-link btn btn-success " style="border-radius:0px;" href="include/users/logout.php">Logout</a>
						<?php endif; ?>
					</li>
				</ul>
			</div>
