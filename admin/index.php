...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading font-weight-bold ">Admin Panel </div>
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-action bg-light active ">Dashboard</a>
        ...
        <a href="students.php" class="list-group-item list-group-item-action bg-light">Students</a>
