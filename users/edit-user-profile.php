        ...
        <div class="col-md-6 m-auto py-4">
          <div class="card" style="width: 350px;">
            ...
            <div class="card-body px-3">
              <div class="card">
                <img class="card-img-top " src="../portal-assets/img/default.png" alt="Card image">
                <div class="mt-2">
                  ...
                  <div class="card-body">
                    <form action="" method="post">
                      <div class="from-group">
                        ...
                        <input type="text" name="name" value="<?php echo $_SESSION['userName'] ?> " id="name"
                          class="form-control">
                      </div>
                      <div class="from-group">
                        <label for="email"> Email* </label>
                        <input type="text" name="email" value="<?php echo $_SESSION['userEmail'] ?> " id="email"
                          class="form-control">
                      </div>
                      <div class="from-group">
