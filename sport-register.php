...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" style="font-family:cursive;" href="#">Gc SP<img
        src="assets/img/logo/main-logo-2.png" alt="Logo" style="width:40px; "> RTS </a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto text-center">
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link  " data-toggle="modal" data-target="#modal-admin" style="border-radius:0px;"
                            href="">Admin</a>
                    </li>
                ...
                <div class="col-md-3">
                    <div class="card my-2" style="">
                        <img class="card-img-top img-fluid"
                            src="admin/upload/teachers/<?php echo $rows['image']; ?>"
                            alt="Card image">
                        <div class="card-body">
